...
func Get_nb_NO() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.GY:    "Guyana",
			territory.HK:    "Hongkong S.A.R. Kina",
